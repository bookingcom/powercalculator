<template>
  <svg
    width="100%"
    height="59px"
    :viewBox="`0 0 ${svgBoxWidth} 59`"
    version="1.1"
    xmlns="http://www.w3.org/2000/svg"
    xmlns:xlink="http://www.w3.org/1999/xlink"
    aria-hidden="true"
    class="pc-svg-chain-icon"
    :style="svgBgLine"
  >
